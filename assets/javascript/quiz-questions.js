var quizQuestions = [
    ...
    {
        id: 2,
        question: "What characters denote a single-line comment in JavaScript?",
        choices: ["<!-- -->", "/* */", "``", "//"],
        answer: "//"
    },
    {
        id: 3,
        question: "What characters enclose a multi-line comment in JavaScript?",
        choices:[ "/* */", "<!-- -->", "``", "| |"],
        answer: "/* */"
    },
    {
    ...
    {
        id: 8,
        question: "Suppose we have the following array in JavaScript: var fruits = ['Apples', 'Oranges', 'Peaches'].  What is the index of element 'Peaches'?",
        choices: ["3", "1", "0", "2"],
        answer: "2"
    },
    {
    ...
    {
        id: 11,
        question: "What character represents the modulus (remainder) operator in JavaScript?",
        choices: ["/", "~", "^", "%"],
        answer: "%"
    }
]